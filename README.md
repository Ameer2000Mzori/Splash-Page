...
> Splash-Page website is crafted with HTML, SCSS, and TypeScript. Figma is used for styling and project mockup. Linters are implemented to address code errors and uphold clean code practices. Please explore the live demo for a hands-on experience.
...
- [Live Demo Link](https://ameer2000mzori.github.io/Splash-Page/src/)
